  ...
  return (
    <section className="max-container">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500 ">
        <p>Software Engineer based in delhi,india, specialising in computer science Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor, quo atque quae voluptatibus modi quas neque laborum vero, minus, id facilis dolorum voluptate.</p>
      </div>
